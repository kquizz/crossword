...
class CluesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clue" do
    assert_difference("Clue.count") do
      post clues_url, params: { clue: { answer: @clue.answer, category: @clue.category, clue_text: @clue.clue_text, difficulty: @clue.difficulty } }
    end
  ...
  test "should update clue" do
    patch clue_url(@clue), params: { clue: { answer: @clue.answer, category: @clue.category, clue_text: @clue.clue_text, difficulty: @clue.difficulty } }
